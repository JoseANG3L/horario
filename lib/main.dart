      ...
      child: Scaffold(
        body: SafeArea(
          child: Column(
            ...
            children: [
              _ScheduleHeader(
                onAddClass: _openAddClassSheet,
                onSaveMateria: _openSaveMateriaSheet,
              ),
              const SizedBox(height: 16),
              const TabBar(
                labelColor: Color(0xFF53D1B6),
                unselectedLabelColor: Colors.white54,
                indicatorColor: Color(0xFF53D1B6),
                tabs: [
                  Tab(text: 'Horario'),
                  Tab(text: 'Materias Guardadas'),
                ],
              ),
              Expanded(
                child: TabBarView(
...
class _ScheduleHeader extends StatelessWidget {
  ...
  final VoidCallback onSaveMateria;

  const _ScheduleHeader({
    required this.onAddClass,
    required this.onSaveMateria,
  });
        ...
        children: [
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Organiza tu semana de un vistazo',
          ...
          Row(
            children: [
              ...
              IconButton.filled(
                onPressed: onSaveMateria,
                tooltip: 'Guardar materia',
                style: IconButton.styleFrom(
                  backgroundColor: const Color(0xFF193A3A),
                  foregroundColor: const Color(0xFF53D1B6),
                  padding: const EdgeInsets.all(12),
                ),
                icon: const Icon(Icons.bookmark_add_rounded, size: 25),
              ),
            ],
          ),
        ],
        ...
        (index) => Tab(
          child: Column(
            ...
            children: [
              ...
              Text(
                '${classCounts[index]} ${classCounts[index] == 1 ? 'clase' : 'clases'}',
...
class _DaySchedule extends StatelessWidget {
  ...
  const _DaySchedule({required this.day, required this.classes});
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                '${widget.classesByDay[widget.selectedDay].length} ${widget.classesByDay[widget.selectedDay].length == 1 ? 'clase' : 'clases'}',
